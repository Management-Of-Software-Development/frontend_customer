...
import AppreciationProductCard from "../components/common/AppreciationProductCard";
import { Col, Row } from "antd";
import { useGetAllAppreciationProductsQuery } from "../api/appreciationProductApi";
...
const AppreciationProductList = ({ title }) => {
	...
	} = useGetAllAppreciationProductsQuery(getProductsParams);
					...
					<ProductsInCategory>
						{isSuccess && allProducts
							? allProducts.data.map((item) => (
									<AppreciationProductCard item={item} />
							  ))
...
export default AppreciationProductList;
